...
class DDPG(object):
    def __init__(self, a_dim, s_dim, a_bound,ON_TRAIN , name):
        ...
        with tf.variable_scope('Critic'+ name):
        ...
        # networks parameters
        self.ae_params = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='Actor'+name+'/eval')
        self.at_params = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='Actor'+name+'/target')
        self.ce_params = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='Critic'+name+'/eval')
        self.ct_params = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='Critic'+name+'/target')
    ...
    def save(self,reward_list, avg_rewards,num, dir):
        saver = tf.train.Saver()
        saver.save(self.sess,  dir +'params_'+str(num))

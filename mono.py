...
thresh= 0.10 #threshold of the penalty for getting closer to obstacle
penalty1 = 4 #po
penalty2 = 4  #ps
...
rl = DDPG(a_dim, s_dim, a_bound,ON_TRAIN, name= 'main3random')
...
def eval():
    ...
    plt.xlabel('episodes')
    plt.ylabel('rewards')
    plt.savefig(dir + 'testDynamicRandom_p1_'+str(penalty1) + '_p2_' + str(penalty2)+'.png')
